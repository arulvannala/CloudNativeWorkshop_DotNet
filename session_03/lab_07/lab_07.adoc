...
Hint:
. Check your application URL in the route tab of your application within Pivotal Cloud Foundry apps manager
. Update fortuneui.yml in https://github.com/mnenad/workshop-config-repo