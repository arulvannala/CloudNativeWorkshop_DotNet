...
It consists of two components, a ``Fortune Teller Service`` and a ``Fortune Teller UI``.
We will work with both of them throughout this lab.

Note that for all of the rest of the labs, we will be using/building on the Fortune Teller application.
--
